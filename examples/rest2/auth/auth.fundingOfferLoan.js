...
const apiPath = 'v2/auth/r/funding/loans/fUSD'
const queryParams = ''
...
const t = new Table({
  ...
  head: ['ID', 'SYMBOL', 'MTS_CREATE', 'MTS_UPDATE', 'AMOUNT', 'FLAGS', 'STATUS', 'RATE']
})

const t1 = new Table({
colWidths: [13,   10,        14,       14,  14,               14,         14,       10],
  head: ['PERIOD', 'NOTIFY', 'MTS_OPENING', 'MTS_LAST_PAYOUT', 'NOTIFY',  'HIDDEN', 'RENEW']
})
